  ...
  return (
    <ScrollView style={styles.container} nestedScrollEnabled={true}>
      ...
      <View style={styles.postReviewCont}>
        ...
        <Text style={{ color: "#EDE9C7", fontSize: 18, textAlign: "center" }}>
          Kunnioitettu sotasankari Eversti Johan August Sandels ajatteli aina
          yhtä taistelua pidemmälle. Eräs nuorempi upseeri ehdotti tiukassa
          tilanteessa joukkojen ryhmittämistä puoli kilometriä taaemmaksi metsä
          suojaan. “Ei hitossa, silloinhan antaisimme viholliselle monta
          hehtaaria viljavaa ohrapeltoa ilmaiseksi”, vastasi Sandels hörpäten
          tuopista pehmeää olutta.
        </Text>
      </View>
      <CommentArea />
    </ScrollView>
